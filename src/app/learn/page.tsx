...
export default function page() {
  return (
    <div className="pb-16">
      <h1 className="pt-28 text-4xl font-medium leading-[3.25rem] text-center px-16">
      ...
      <div className="px-32 [&>*]:py-6">
        ...
        <div className="flex flex-row justify-center !pb-0">
          ...
          <div>
            <p>
              ...
              momentary pause that makes your heart skip a beat. That&apos;s
              what double consonants are in the realm of Japanese. They&apos;re
              like tiny, suspenseful hiccups in words that add a whole layer of
              drama.
            </p>
            <br />
            <p>
              Take &quot;
              <span className={`font-semibold`}>がっこう</span> (gakkou -
              school).&quot; Without the double &apos;k&apos;, it would just be
              a boring old &quot;gakou.&quot; But with that extra &apos;k&apos;,
              suddenly, it&apos;s (gak-kou) a word with a bit more punch, a bit
              more{" "}
              <span className="">
                &quot;
                <u>
        ...
        <div className="flex flex-row justify-center !pb-0">
          ...
          <div>
            <p>
              Now, let&apos;s switch gears to long vowels. If double consonants
              are the dramatic pauses, long vowels are like stretching a rubber
            ...
            <p>
              ...
              grandmother).&quot; If you don&apos;t stretch the &apos;aa&apos;,
              you might end up calling someone &quot; お<u>ば</u>
        ...
        <p>
          ...
          having trouble right now, fear not! You&apos;ll be hearing and saying
          them throughout your Japanese journey.
        </p>
        ...
        <p>
          <span className="text-2xl font-bold">Mastering the Art:</span> Getting
          these sounds right might feel like trying to pat your head and rub
          your belly at the same time. But once you get the hang of it,
          you&apos;ll be weaving through Japanese conversations with the grace
        ...
        <p>
          ...
          phonetics, <u>more is more</u>. Revel in the glory of sounding like a{" "}
          <em>true</em> Nihongo master, and let the double consonants and long
          vowels add that extra *zing* to your linguistic journey! ✨
        </p>
      </div>
