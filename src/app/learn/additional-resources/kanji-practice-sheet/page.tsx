...
export default function Page() {
  ...
  return (
    <div className="overflow-x-auto print:bg-white">
      <BackgroundImage
        backgroundImage="/img/dust-splatter-1.png"
        backgroundImageSize="1215px"
        backgroundImageOpacity={5}
      />
      <div className="origin-top-left scale-50 lg:scale-75 2xl:scale-100">
        <div className="min-h-screen min-w-[1780px] pb-28 pt-24 sm:px-16 md:px-24 lg:px-12">
          <AspectRatio
            ref={printRef}
            ratio={8.5 / 11}
